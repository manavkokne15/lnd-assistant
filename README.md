...
![CI/CD](https://github.com/manavkokne15/lnd-assistant/actions/workflows/ci-cd.yml/badge.svg)
![Code Quality](https://github.com/manavkokne15/lnd-assistant/actions/workflows/code-quality.yml/badge.svg)
...
Google's [Agent Starter Pack](https://googlecloudplatform.github.io/agent-starter-pack/) is a feature-rich framework with extensive tooling and multi-platform CI/CD options. `lnd-assistant` takes a different approach:
...
This project distills proven patterns from the Starter Pack while prioritizing build efficiency, deployment simplicity, and infrastructure transparency. Use the Starter Pack for rapid prototyping with Agent Engine; use `lnd-assistant` for thoughtfully-curated developer experience and production deployments requiring optimization and control.
